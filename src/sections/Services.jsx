...
export default function Services() {
  return (
    <div className="w-[90%] my-[10vh] relative mx-auto">
      ...
      <p className="text-center font-medium uppercase pb-14">[ Services ]</p>
      <div className="w-full flex items-center justify-between">
        <div className="w-[35%] h-[45vh] bento-card  rounded-md p-5 pb-3">
        ...
        <div className="w-[60%] h-[45vh] bento-card rounded-md p-5">
